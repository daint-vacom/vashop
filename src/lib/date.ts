...
export function formatDateTime(date: Date | undefined | null) {
  return date ? format(date, 'HH:mm, dd/MM/yyyy') : '';
}

export function formatDateOnly(date: Date | undefined | null) {
  return date ? format(date, 'dd/MM/yyyy') : '';
}

export function formatMonthYear(date: Date | undefined | null) {
