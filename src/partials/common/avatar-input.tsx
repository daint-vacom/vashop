...
export function AvatarInput() {
  ...
  const currentAvatar = avatar.length > 0 ? avatar[0].dataURL : defaultAvatar;
    ...
    >
      {({ onImageUpload }) => (
        ...
        >
          ...
          <div className="relative border-2 border-green-500 rounded-full overflow-hidden w-16 h-16">
            <img
              src={currentAvatar}
              alt="avatar"
