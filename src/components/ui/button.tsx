...
import { ChevronDown, LoaderCircleIcon, LucideIcon } from 'lucide-react';
  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        success:
          'bg-success hover:bg-success-active data-[state=open]:bg-success-active text-white',
        'success-outline':
          'bg-background text-success border border-success hover:bg-accent data-[state=open]:bg-accent',
        secondary:
      ...
      size: {
        ...
        'table-action':
          'size-7 rounded-md px-3 gap-1.5 text-[0.8125rem] leading-(--text-sm--line-height) [&_svg:not([class*=size-])]:size-4',
      },
      autoHeight: {
        true: '',
        false: '',
